...
export type TodosWhereInput = {
    ...
    user_id?: Prisma.IntFilter<"Todos"> | number;
};
...
export type TodosScalarWhereWithAggregatesInput = {
    ...
    user_id?: Prisma.IntWithAggregatesFilter<"Todos"> | number;
};
...
export type TodosOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "description" | "done" | "user_id", ExtArgs["result"]["todos"]>;
...
export interface TodosFieldRefs {
    ...
    readonly user_id: Prisma.FieldRef<"Todos", 'Int'>;
}
/**
 * Todos findUnique
 */
